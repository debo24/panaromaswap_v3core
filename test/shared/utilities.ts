...
export function createPoolFunctions({
  ...
  swapTarget: TestPanaromaswapV3Callee
  token0: TestERC20
  token1: TestERC20
  pool: MockTimePanaromaswapV3Pool
}): PoolFunctions {
...
export function createMultiPoolFunctions({
  ...
  swapTarget: TestPanaromaswapV3Router
  poolInput: MockTimePanaromaswapV3Pool
  poolOutput: MockTimePanaromaswapV3Pool
}): MultiPoolFunctions {
