...
import { PanaromaswapV3PoolSwapTest } from '../typechain/PanaromaswapV3PoolSwapTest'
...
describe('PanaromaswapV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('PanaromaswapV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as PanaromaswapV3PoolSwapTest
          ...
          let tester: PanaromaswapV3PoolSwapTest
