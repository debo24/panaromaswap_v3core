...
import { TestPanaromaswapV3SwapPay } from '../typechain/TestPanaromaswapV3SwapPay'
...
import { TestPanaromaswapV3ReentrantCallee } from '../typechain/TestPanaromaswapV3ReentrantCallee'
...
describe('PanaromaswapV3Pool', () => {
  ...
  let factory: PanaromaswapV3Factory
  let pool: MockTimePanaromaswapV3Pool

  let swapTarget: TestPanaromaswapV3Callee
  ...
  async function initializeAtZeroTick(pool: MockTimePanaromaswapV3Pool): Promise<void> {
    await pool.initialize(encodePriceSqrt(1, 1))
  ...
  // https://github.com/Panaromaswap/panaromaswap-v3-core/issues/214
  ...
  describe('#lock', () => {
    ...
    it('cannot reenter from swap callback', async () => {
      const reentrant = (await (
        await ethers.getContractFactory('TestPanaromaswapV3ReentrantCallee')
      ).deploy()) as TestPanaromaswapV3ReentrantCallee
  ...
  describe('swap underpayment tests', () => {
    let underpay: TestPanaromaswapV3SwapPay
    beforeEach('deploy swap test', async () => {
      const underpayFactory = await ethers.getContractFactory('TestPanaromaswapV3SwapPay')
      underpay = (await underpayFactory.deploy()) as TestPanaromaswapV3SwapPay
