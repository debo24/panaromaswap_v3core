...
describe('PanaromaswapV3Pool', () => {
  ...
  let pool0: MockTimePanaromaswapV3Pool
  let pool1: MockTimePanaromaswapV3Pool
  ...
  let swapTargetCallee: TestPanaromaswapV3Callee
  let swapTargetRouter: TestPanaromaswapV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimePanaromaswapV3Pool, any]> => {
